...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used for various session messages that
    ...
    */
    ...
    'confirm_success' => 'New :entity has been confirmed.',
    ...
    'upload_error'    => 'An error occurred uploading file(Only PDF files are allowed!!)',
    'sent_success'    => 'Your :entity Sent Successfully!!',
];
